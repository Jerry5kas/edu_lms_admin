...
<!-- Sidebar -->
<aside
    class="fixed z-50 lg:z-0 inset-y-0 left-0 w-64 bg-white shadow-md lg:static transform transition-transform duration-200 ease-in-out"
    ...
    <nav class="px-4 py-6 space-y-2 text-gray-700 text-sm">
        ...
        <div x-data="{ dropdown:false }">
            <button @click="dropdown=!dropdown" class="flex items-center w-full px-3 py-2 rounded-lg hover:bg-blue-50 text-blue-600 font-medium">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7m-9 2v8m-4 4h12a2 2 0 002-2V10a2 2 0 00-.586-1.414l-7-7a2 2 0 00-2.828 0l-7 7A2 2 0 003 10v10a2 2 0 002 2z" />
                </svg>
                Dashboard
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path :class="{'rotate-180':dropdown}" class="transition-transform" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
            </button>
            <div x-show="dropdown" class="ml-8 mt-1 space-y-1 text-gray-500" x-cloak>
                <a href="#" class="block py-1">Dashboard One</a>
                <a href="#" class="block py-1">Dashboard Two</a>
                <a href="#" class="block py-1">Dashboard Three</a>
            </div>
        </div>
