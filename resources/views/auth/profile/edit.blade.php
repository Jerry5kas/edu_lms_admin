        ...
        <div class="bg-white shadow-xl rounded-2xl p-6 md:p-8 w-full max-w-4xl">
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-6">
                ...
                <div class="flex flex-col items-center md:items-start">
                    <div
                        x-data="{
                            preview: '{{ Auth::user()->profile ? asset('storage/profile_images/' . Auth::user()->profile) : '' }}'
                        }"
                        class="relative"
                    >
                        {{-- Profile Image / Placeholder --}}
                        <img
                            :src="preview || 'https://via.placeholder.com/150/3B82F6/FFFFFF?text={{ urlencode(substr(Auth::user()->name ?? 'U', 0, 1)) }}'"
                            alt="Profile"
                ...
                <div class="flex-1 text-center md:text-left">
                    ...
                    <p class="text-gray-500 mt-1">Joined in {{ date('Y') }}</p>
