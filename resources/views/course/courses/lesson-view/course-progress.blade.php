<x-layouts.main>
    <div class="bg-white p-6">
        <div class="w-full max-w-7xl mx-auto">
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Course Progress Overview</h1>
                <p class="text-gray-600">Student progress for: <strong>{{ $course->title }}</strong></p>
            </div>
            ...
            <div class="bg-blue-50 rounded-lg p-4 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        <span class="text-sm font-medium text-gray-600">Course Title:</span>
                    ...
                    <div>
                        <span class="text-sm font-medium text-gray-600">Total Lessons:</span>
                        <p class="text-gray-900">{{ $stats['total_lessons'] }}</p>
                    </div>
                    <div>
                        <span class="text-sm font-medium text-gray-600">Total Students:</span>
                        <p class="text-gray-900">{{ $stats['total_students'] }}</p>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $stats['completed_views'] }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $stats['total_views'] - $stats['completed_views'] }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                {{ $stats['total_views'] > 0 ? number_format(($stats['completed_views'] / $stats['total_views']) * 100, 1) : 0 }}%
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">All Lesson Views for This Course</h3>
                </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="px-6 py-4 text-center text-gray-500">
                                        No lesson views found for this course.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
