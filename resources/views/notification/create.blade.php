    ...
    <div class="bg-gray-50 min-h-screen p-4 flex justify-center items-center">
        <div class="bg-white shadow-lg rounded-2xl w-full max-w-3xl p-6 space-y-6">
            ...
            <form method="POST" action="#" class="space-y-5"
                  x-data="{ title: '', message: '', type: 'system', channel: 'email', scheduled: '' }">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="message" x-model="message" rows="4"
                              class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-400 focus:outline-none"
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-end">
                    ...
                    <button type="submit"
                            class="flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg shadow">
                        <!-- Heroicon: check -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
